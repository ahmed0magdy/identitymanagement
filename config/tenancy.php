...
return [
    ...
    'database' => [
        ...
        'managers' => [
           ...
           // 'sqlsrv' => \App\vendor\SqlServerDatabaseManager::class,
         ...
         */
            ...
            /**
             * Use this database manager for SqlSrv to have a DB user created for each tenant database.
             * You can customize the grants given to these users by changing the $GrantPermissions property.
             */
             'sqlsrv' => \App\vendor\PermissionControlledSQLServerDatabaseManager::class,
